...
var useNuiCallback = function (app, method, handler, errHandler) {
    var _a = (0, react_1.useContext)(NuiContext_1.NuiContext), sendAbortable = _a.sendAbortable, callbackTimeout = _a.callbackTimeout;
    var fetchRef = (0, react_1.useRef)(null);
    if (!app || !method) {
        throw new Error("App and method are required arguments.");
    }
    ...
    // has timed out
    var _b = (0, react_1.useState)(false), timedOut = _b[0], setTimedOut = _b[1];
    ...
    var _f = (0, react_1.useState)(null), response = _f[0], setResponse = _f[1];
    var onSuccess = (0, react_1.useCallback)(function (data) {
        if (!loading) {
            return;
        }
    ...
    var fetch = (0, react_1.useCallback)(function (data, options) {
            ...
            if (!curr) {
                ...
                if (timeoutTime_1 && !failed) {
                    ...
                    timeoutRef.current = setTimeout(function () {
                        setTimedOut(true);
                        onError(new Error("react-fivem-nui-utils: \"".concat(eventNameRef.current, "\" event callback timed out after ").concat(timeoutTime_1, " milliseconds")));
